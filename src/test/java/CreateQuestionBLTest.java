...
class CreateQuestionBLTest {
	...
	void test1() {
		try {
			...
			int questiontype = 1;
			String pmultiply = "2";
			ev = testBL.addEventWithQuestion(eventText, oneDate, queryText, betMinimum,questiontype, pmultiply);
	...
	void test2() {
		try {
			...
			ev = testBL.addEventWithQuestion(eventText, oneDate, "One", 3f,questiontype, pmultiply);
