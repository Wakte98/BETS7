...
public class TestUtilityFacadeImplementation {
	   ...
	   public TestUtilityFacadeImplementation()  {			
		...
		public Event addEventWithQuestion(String desc, Date d, String question, float qty, int questiontype,String multiplier) {
			dbManagerTest.open();
			Event o=dbManagerTest.addEventWithQuestion(desc,d, question, qty,questiontype,multiplier);
			dbManagerTest.close();
			return o;
